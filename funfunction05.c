undefined  [16] FUN_100004054(uint param_1)

{
  ...
  if (param_1 != 0) {
    return ZEXT416(param_1) << 0x40;
  }
  auVar13._0_8_ = FUN_10005339c();
  if (auVar13._0_8_ != 0) {
    auVar13._8_8_ = 0;
    return auVar13;
  }
  ...
  iVar5 = FUN_10005347c();
  lVar11 = 0;
  lStack_c8 = *(long *)PTR____stack_chk_guard_100075060;
...
LAB_1000042f4:
    ...
    auVar18._0_8_ = uVar7;
    if (*(long *)PTR____stack_chk_guard_100075060 == lStack_c8) {
      auVar17._8_8_ = uVar10;
      auVar17._0_8_ = ppdVar12;
      return auVar17;
    }
    goto LAB_100004330;
  }
  ...
  *(int *)(ppdVar12 + 1) = iVar5;
  ...
  iVar5 = _pthread_attr_init((pthread_attr_t *)auStack_110);
  if (iVar5 == 0) {
    iVar5 = _pthread_attr_setdetachstate((pthread_attr_t *)auStack_110,2);
    if (iVar5 != 0) goto LAB_100004328;
    p_Stack_118 = (pthread_t)0x0;
    uVar4 = _pthread_create(&p_Stack_118,(pthread_attr_t *)auStack_110,(void **)FUN_1000043c8,
                            ppdVar12);
    uVar6 = _pthread_attr_destroy((pthread_attr_t *)auStack_110);
    uVar7 = (ulong)uVar6;
    if (uVar6 == 0) {
      if (uVar4 == 0) {
        uVar10 = 0;
...
LAB_100004328:
  ...
  auVar18 = FUN_100053498();
LAB_100004330:
                    /* WARNING: Subroutine does not return */
  ___stack_chk_fail(auVar18._0_8_,auVar18._8_8_);
}
